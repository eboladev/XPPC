...
*/
class NCREPORT_LIB_API NCReportPageOption
{
public:
	NCReportPageOption();
	...
	void setPageSize( const QString& paperSizeName,  const QSizeF& customSize );
	//void setCustomPageSize( const QSizeF& );
	void setOrientation( const QPrinter::Orientation );
	static void paperSizeByName( const QString psname, const QPrinter::Orientation orient, QPrinter::PaperSize& psid, QSizeF& size );
