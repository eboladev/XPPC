...
{
public:
	NCReportTextData() : document(0), requiredHeightMM(0), useFont(true), defaultPosAndSize(false), sizeFix(false), plainText(false),
		forecolor(Qt::black)
	{}
...
private:
	...
	QString convertPlainToHtml( const QString& text) const;
};
