...
void MimeMessage::deleteRecipient(EmailAddress *rcpt)
{

    recipientsTo.removeAll(rcpt);
    recipientsCc.removeAll(rcpt);
    recipientsBcc.removeAll(rcpt);
    delete rcpt;
}
...
void MimeMessage::deletePart(MimePart *part)
{
    delete part;
}
